...
The console represents the start of the AirBnB project at Holberton School, teaching essential high-level programming concepts. Its aim is to replicate the functionality of the AirBnB website. This section introduces a command interpreter for managing objects within the AirBnB website.

#### Command Interpreter Functions:
* Create a new object (e.g., a User or a Place)
...
* Run AirBnb (interactively): `./console` and enter a command
* Run AirBnb (non-interactively): `echo "<command>" | ./console.py`

## File Descriptions
[console.py](console.py) - serves as the entry point of the command interpreter. 
List of commands currently supported:
* `EOF` - exits console 
* `quit` - exits console
